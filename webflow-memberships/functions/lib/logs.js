...
exports.customFunctionError =
  ...
  exports.storagePathDeleted =
  exports.storageNotConfigured =
  exports.storageDeleting =
  exports.storageDeleted =
  exports.start =
  exports.rtdbPathError =
  exports.rtdbPathDeleting =
  exports.rtdbNotConfigured =
  exports.rtdbPathDeleted =
  exports.rtdbDeleting =
  exports.rtdbDeleted =
  exports.init =
  exports.firestorePathError =
  exports.firestorePathDeleting =
  exports.firestorePathDeleted =
...
const firestoreDeleted = () => {
  firebase_functions_1.logger.log(
    "Finished deleting user data from Cloud Firestore"
  );
};
...
const firestoreNotConfigured = () => {
  firebase_functions_1.logger.log(
    "Cloud Firestore paths are not configured, skipping"
  );
};
...
const rtdbDeleted = () => {
  firebase_functions_1.logger.log(
    "Finished deleting user data from the Realtime Database"
  );
};
exports.rtdbDeleted = rtdbDeleted;
const rtdbDeleting = () => {
  firebase_functions_1.logger.log(
    "Deleting user data from the Realtime Database"
  );
};
exports.rtdbDeleting = rtdbDeleting;
const rtdbPathDeleted = (path) => {
  firebase_functions_1.logger.log(
    `Deleted: '${path}' from the Realtime Database`
  );
};
exports.rtdbPathDeleted = rtdbPathDeleted;
const rtdbNotConfigured = () => {
  firebase_functions_1.logger.log(
    "Realtime Database paths are not configured, skipping"
  );
};
exports.rtdbNotConfigured = rtdbNotConfigured;
const rtdbPathDeleting = (path) => {
  firebase_functions_1.logger.log(
    `Deleting: '${path}' from the Realtime Database`
  );
};
...
const storageDeleted = () => {
  firebase_functions_1.logger.log(
    "Finished deleting user data from Cloud Storage"
  );
};
...
const storageNotConfigured = () => {
  firebase_functions_1.logger.log(
    "Cloud Storage paths are not configured, skipping"
  );
};
...
const storagePath404 = (path) => {
  firebase_functions_1.logger.log(
    `File: '${path}' does not exist in Cloud Storage, skipping`
  );
};
exports.storagePath404 = storagePath404;
const storagePathError = (path, err) => {
  firebase_functions_1.logger.error(
    `Error deleting: '${path}' from Cloud Storage`,
    err
  );
};
